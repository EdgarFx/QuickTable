...
for table in tables:
    if language == "Chinese":
        os.system('python TableStructure/ppstructure/table/predict_table.py \
            --det_model_dir=TableStructure/ppstructure/inference/ch_PP-OCRv3_det_infer \
            --rec_model_dir=TableStructure/ppstructure/inference/ch_PP-OCRv3_rec_infer \
            --table_model_dir=TableStructure/ppstructure/inference/ch_ppstructure_mobile_v2.0_SLANet_infer \
            --rec_char_dict_path=TableStructure/ppocr/utils/ppocr_keys_v1.txt \
            --table_char_dict_path=TableStructure/ppocr/utils/dict/table_structure_dict_ch.txt \
            --image_dir=det_tables/%s --output=output/%s'%(table,table[:-4]))
    elif language == "English":
        os.system('python TableStructure/ppstructure/table/predict_table.py \
            --det_model_dir=TableStructure/ppstructure/inference/en_PP-OCRv3_det_infer \
            --rec_model_dir=TableStructure/ppstructure/inference/en_PP-OCRv3_rec_infer \
            --table_model_dir=TableStructure/ppstructure/inference/en_ppstructure_mobile_v2.0_SLANet_infer \
            --rec_char_dict_path=TableStructure/ppocr/utils/ppocr_keys_v1.txt \
            --table_char_dict_path=TableStructure/ppocr/utils/dict/table_structure_dict_ch.txt \
            --image_dir=det_tables/%s --output=output/%s'%(table,table[:-4]))
